...
describe('nodex:app', () => {
  ...
  describe('running on new project', () => {
    it('scaffold a full project', () => {
      const answers = {
        name: packageName,
        description: 'A node generator with extended features by NEWBRAN.CH',
