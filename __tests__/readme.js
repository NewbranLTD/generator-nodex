...
const _projectName = 'my-project';

describe('nodex:readme', () => {
  beforeEach(() => {
    return helpers
  ...
  it('creates and fill contents in README.md', () => {
    ...
    assert.fileContent('README.md', `const myProject = require('${_projectName}');`);
    assert.fileContent('README.md', '> a cool project');
    assert.fileContent('README.md', `$ npm install --save ${_projectName}`);
    assert.fileContent('README.md', `$ yarn add ${_projectName}`);
    assert.fileContent('README.md', 'MIT © [Yeoman](http://yeoman.io)');
    assert.fileContent(
      'README.md',
      `[travis-image]: https://travis-ci.org/yeoman/${_projectName}.svg?branch=master`
    );
...
describe('node:readme --generate-into', () => {
  ...
  it('creates and fill contents in README.md', () => {
    ...
    assert.fileContent(
      'other/README.md',
      `const myProject = require('${_projectName}');`
    );
    assert.fileContent('other/README.md', '> a cool project');
    assert.fileContent('other/README.md', `$ npm install --save ${_projectName}`);
